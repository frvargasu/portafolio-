...
| `GET` | `/productos/barcode/:codigo` | Buscar por código | Sí |
| `POST` | `/productos` | Crear producto | Admin |
| `PUT` | `/productos/:id/stock` | Actualizar stock | Sí |
| `GET` | `/ventas` | Listar ventas | Sí |
| `POST` | `/ventas` | Registrar venta | Sí |
| `GET` | `/reportes/dashboard` | Datos del dashboard | Sí |
...
<p align="center">
  Desarrollado para el portafolio de DUOC UC
</p>
# 🏪 Sistema de Inventario y Ventas PYME
